...
static MDFNSetting DriverSettings[] =
{
  ...
  { "nes.xscale", CSD_xscale, MDFNST_FLOAT, "1" },
  { "nes.yscale", CSD_yscale, MDFNST_FLOAT, "1" },
  ...
  { "gb.xscale", CSD_xscale, MDFNST_FLOAT, "1" },
  { "gb.yscale", CSD_yscale, MDFNST_FLOAT, "1" },
  ...
  { "gba.xscale", CSD_xscale, MDFNST_FLOAT, "1" },
  { "gba.yscale", CSD_yscale, MDFNST_FLOAT, "1" },
  ...
  { "gg.xscale", CSD_xscale, MDFNST_FLOAT, "1" },
  { "gg.yscale", CSD_yscale, MDFNST_FLOAT, "1" },
  ...
  { "lynx.xscale", CSD_xscale, MDFNST_FLOAT, "1" },
  { "lynx.yscale", CSD_yscale, MDFNST_FLOAT, "1" },
  ...
  { "ngp.xscale", CSD_xscale, MDFNST_FLOAT, "1" },
  { "ngp.yscale", CSD_yscale, MDFNST_FLOAT, "1" },
  ...
  { "pce.xscale", CSD_xscale, MDFNST_FLOAT, "1" },
  { "pce.yscale", CSD_yscale, MDFNST_FLOAT, "1" },
  ...
  { "pcfx.xscale", CSD_xscale, MDFNST_FLOAT, "1" },
  { "pcfx.yscale", CSD_yscale, MDFNST_FLOAT, "1" },
  ...
  { "sms.xscale", CSD_xscale, MDFNST_FLOAT, "1" },
  { "sms.yscale", CSD_yscale, MDFNST_FLOAT, "1" },
  ...
  { "wswan.xscale", CSD_xscale, MDFNST_FLOAT, "1" },
  { "wswan.yscale", CSD_yscale, MDFNST_FLOAT, "1" },
...
void MDFND_Update(uint32 *XBuf, int16 *Buffer, int Count)
{
  ...
  */
  ...
  // if(delay_time > 0)
  // {
  //  MDFN_DispMessage((UTF8*)"%d", delay_time);
