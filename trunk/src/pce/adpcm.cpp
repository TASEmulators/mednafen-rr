...
static inline int32 saturated_addition(int32 val, int32 add, int32 min, int32 max)
{
	val += add;
...
static inline int32 decode(uint8 code)
{
...
static INLINE void ADPCM_AdvanceClock(int32  cycles)
{
        if (bFadeOut || bFadeIn)
        {
                ClockCount += cycles;
